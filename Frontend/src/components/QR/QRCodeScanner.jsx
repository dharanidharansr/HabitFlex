    ...
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="flex border-b border-[rgb(var(--border-primary))] mb-4">
          <button
            className={`py-2 px-4 font-medium text-sm ${activeTab === 'camera' ? 'text-[rgb(var(--accent-primary))] border-b-2 border-[rgb(var(--accent-primary))]' : 'text-[rgb(var(--text-primary))]/60 hover:text-[rgb(var(--text-primary))]'
              }`}
          ...
          <button
            className={`py-2 px-4 font-medium text-sm ${activeTab === 'image' ? 'text-[rgb(var(--accent-primary))] border-b-2 border-[rgb(var(--accent-primary))]' : 'text-[rgb(var(--text-primary))]/60 hover:text-[rgb(var(--text-primary))]'
              }`}
